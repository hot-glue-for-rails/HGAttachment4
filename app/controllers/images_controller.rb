class ImagesController < ApplicationController
  ...
  # rails generate hot_glue:scaffold Image --include='name:avatar' --gd --attachments='avatar{thumb||direct|dropzone}'
  ...
  def load_all_images
    @images = Image.page(params[:page]).includes(:avatar_attachment)
  end
